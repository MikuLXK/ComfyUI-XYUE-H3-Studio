...
class XYUEH3ImageAsset(io.ComfyNode):
    ...
    def define_schema(cls):
        return io.Schema(
            ...
            category=CATEGORY,
            description="导入图片，自动以文件名建立别名；关闭启用后不会参与素材编号。",
            inputs=[
                io.Combo.Input(
                    "image",
                ...
                io.Combo.Input("alias_mode", display_name="别名模式", options=["@文件名", "@图片N"], default="@文件名"),
    ...
    def define_schema(cls):
        return io.Schema(
            ...
            inputs=[
                ...
                io.Combo.Input("alias_mode", display_name="别名模式", options=["@文件名", "@视频N"], default="@文件名"),
    ...
    def define_schema(cls):
        return io.Schema(
            ...
            inputs=[
                ...
                io.Combo.Input("alias_mode", display_name="别名模式", options=["@文件名", "@音频N"], default="@文件名"),
